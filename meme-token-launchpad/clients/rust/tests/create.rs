...
use wybe_meme_token_launchpad_client::{accounts::Counter, instructions::CreateBuilder};
...
#[tokio::test]
async fn create() {
    let mut context = ProgramTest::new("wybe_meme_token_launchpad", wybe_meme_token_launchpad_client::ID, None)
        .start_with_context()
        .await;
